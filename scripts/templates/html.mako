...
<%def name="show_module(module)">
  ...
  <section id="section-items">
    % if (len(variables) > 0) | (len(classes) > 0) | (len(functions) > 0):
    <h1 class="section-title" id="api-documentation">API Documentation</h1>
    % endif
    ${"---" | mark}
    ## % if len(variables) > 0:
    ## % for v in variables:
...
<%def name="module_index(module)">
  ...
  %>
  <div id="sidebar">
    <h2><a href="./index.html">Velox Home</a></h2>
...
<head>
  ...
  % else:
    ...
    <meta name="description" content="Velox manages machine learning models in production environments." />
